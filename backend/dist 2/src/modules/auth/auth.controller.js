...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Post)('cadastro-empresa'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CadastroEmpresaDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "cadastroEmpresa", null);
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Post)('create-account-from-order'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateAccountFromOrderDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "createAccountFromOrder", null);
__decorate([
    (0, public_decorator_1.Public)(),
