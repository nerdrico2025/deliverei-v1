...
type PushPayload = { message: string; tone?: 'success' | 'error' | 'warning' | 'info'; duration?: number };
...
export const ToastProvider = ({ children }: { children: ReactNode }) => {
  ...
  const push = useCallback((payload: PushPayload) => {
    const type: Toast['type'] = payload.tone ?? 'info';
    addToast(payload.message, type, payload.duration);
  }, [addToast]);
