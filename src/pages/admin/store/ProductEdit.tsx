    ...
    <DashboardShell sidebar={<StoreSidebar />}> 
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" onClick={() => navigate("/admin/store/products")}>
            Voltar
          </Button>
        </div>
        ...
        <ProductForm
          initialData={{
            ...
            ativo: product.ativo,
            promo_tag: product.promo_tag ?? false,
            bestseller_tag: product.bestseller_tag ?? false,
            new_tag: product.new_tag ?? false,
          }}
