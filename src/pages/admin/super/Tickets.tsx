...
export default function TicketsPage() {
  ...
  const [list, setList] = useState<Ticket[]>([
    { id: "t1", empresa: "Marmita Boa", titulo: "Dúvida sobre cobrança", status: "aberto", prioridade: "media", criadoEm: "2025-10-05 11:20" },
    { id: "t2", empresa: "Fit Express", titulo: "Erro ao criar produto", status: "em_andamento", prioridade: "alta", criadoEm: "2025-10-05 10:00", atribuido: "Suporte 1" },
    { id: "t3", empresa: "Delivery Top", titulo: "Integração WhatsApp", status: "resolvido", prioridade: "baixa", criadoEm: "2025-10-04 14:30", atribuido: "Suporte 2" },
  ]);
  ...
  return (
    <DashboardShell sidebar={<SuperAdminSidebar currentPath="/admin/super/tickets" />}>
